...
RUN installUtility install --acceptLicense microprofile-3.0 jdbc-4.2 jms-2.0 jca-1.7 jndi-1.0 appsecurity-2.0 monitor-1.0 jpa-2.2 jwt-1.0 mpJwt-1.1 jwtsso-1.0
RUN configure.sh
